    ...
    this.update = function (delta) {
        ...
        switch (animationType) {
            ...
            case AnimationType.TRANSLATION:
                ...
                if (Math.abs(animationTarget.position.getComponent(animationAxis) - endPositionValue) < 0.01) {
                    ...
                    if (animationTarget.position.getComponent(animationAxis) < endPositionValue) {
                        newTranslation = animationTarget.position.getComponent(animationAxis) + animationSpeed * delta;
                    } else {
                        newTranslation = animationTarget.position.getComponent(animationAxis) - animationSpeed * delta;
                    }
            ...
            case AnimationType.ROTATION:
                ...
                if (Math.abs(animationTarget.rotation.toVector3().getComponent(animationAxis) - endPositionValue) < 0.01) {
                    ...
                    if (animationTarget.rotation.toVector3().getComponent(animationAxis) < endPositionValue) {
                        newRotation.setComponent(animationAxis, animationTarget.rotation.toVector3().getComponent(animationAxis) + animationSpeed * delta);
                    } else {
                        newRotation.setComponent(animationAxis, animationTarget.rotation.toVector3().getComponent(animationAxis) - animationSpeed * delta);
                    }
                    animationTarget.rotation.setFromVector3(newRotation);
